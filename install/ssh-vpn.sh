...
REPO2="https://raw.githubusercontent.com/sehuadri/scnew/main/install/"
# initializing var
...
wget -O /etc/haproxy/haproxy.cfg "https://raw.githubusercontent.com/sehuadri/scnew/main/install/haproxy.cfg"
